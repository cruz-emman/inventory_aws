...
import { Archive, Layout, LucideIcon, Menu, Clipboard, Users, SlidersHorizontal, CircleDollarSign } from 'lucide-react'
import Image from 'next/image'
import Link from 'next/link'
import { usePathname } from 'next/navigation'
import React from 'react'

interface SidebarLinksPorps {
    href: string,
    icon: LucideIcon,
    label: string,
    isCollapsed: boolean
...
const Sidebar = () => {
    ...
    return (
        <div className={sidebarClassNames}>
            ...
            <Image
                src="https://s3-nventorymanagement.s3.ap-southeast-1.amazonaws.com/logo.png"
                alt='Profile'
                width={27}
                height={27}
                className='rounded w-8'
              />
                <h1 className={`${isSidebarCollapsed ? "hidden" : "block"} font-extrabold text-2xl`}>Emman</h1>
            ...
            <div className='flex-grow mt-8'>
                ...
                <SidebarLink href="/clipboard" icon={Clipboard} label="Clipboard" isCollapsed={isSidebarCollapsed} />
            ...
            <div className={`${isSidebarCollapsed ? "hidden" : "block"} mb-10`}>
                <p className='text-center text-xs text-gray-500'>&copy; 2024 Emmanm</p>
            </div>
